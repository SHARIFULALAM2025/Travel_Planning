    ...
    <div>
      <section className="relative w-full h-[50vh] md:h-[70vh] min-h-[400px] overflow-hidden">
        <motion.div
          ...
          style={{
            backgroundImage: `url('https://i.ibb.co.com/R43PfrX7/cruise-large-04.jpg')`,
          }}
        />
        ...
        <div style={bgStyle} className="grid grid-cols-12  gap-4">
          ...
          <section className="col-span-12 lg:col-span-9 md:mt-3 space-y-5">
            <div className="flex flex-col md:flex-row justify-between items-start gap-6">
              <div className="space-y-4 w-full">
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  >
                    {singleFlight?.cruiseName?.[locale] || 'Loading...'}
                  </h1>
                  <div className="flex gap-2">
                    <span className="bg-emerald-100 text-emerald-600 text-[10px] font-bold px-3 py-1 rounded-full flex items-center gap-1 uppercase">
                      <FaRegCheckCircle size={10} />{' '}
                      {singleFlight?.verifiedStatus?.[locale]}
                    </span>
                    <span className="bg-blue-100 text-blue-600 text-[10px] font-bold px-3 py-1 rounded-full uppercase">
                      {singleFlight?.cat?.[locale]}
                    </span>
                  </div>
                </div>

                <div className="flex flex-wrap items-center gap-3 md:gap-6 text-sm text-slate-500 font-semibold">
                  <span
                    className={`flex items-center gap-1 ${theme === 'dark' ? 'text-white' : 'text-slate-900'}`}
                  >
                    <GiCruiser className="text-rose-500 rotate-45" size={18} />
                    {singleFlight?.cat?.[locale]}
                  </span>
                  ...
                  <span className="hidden md:inline text-slate-300">|</span>
                  <div className="flex items-center gap-1 bg-orange-50 px-3 py-1 rounded-lg text-orange-600 font-black">
                    <FaStarHalf size={14} /> {singleFlight?.rating?.[locale]}
                ...
                <div className="border-t grid grid-cols-3">
                  <div className="flex gap-1 items-center ">
                    ...
                    <div className="">
                      ...
                      <h1 className="">
                        {singleFlight?.details?.duration?.[locale]}
                      </h1>
                    </div>
                  </div>
                  <div className="flex gap-1 items-center ">
                    <FaUsers />
                    <div className="">
                      <h1 className="">No of Guests</h1>
                      <h1 className="">{singleFlight?.details?.noOfGuests}</h1>
                    </div>
                  </div>
                  <div className="flex gap-1 items-center ">
                    <FaCalendarAlt />
                    <div className="">
                      ...
                      <h1 className="">
                        {singleFlight?.details?.date?.[locale]}
                      </h1>
                    </div>
                  </div>
                </div>
            ...
            <Accordion
              title={'itinerary'}
              content={
                <div className="max-w-4xl mx-auto py-10 pl-10 pr-6 relative">
                  {/* Vertical Line */}
                  <div className="absolute left-[45px] top-10 bottom-10 w-[2px]  bg-gray-100 border-l-2 border-dotted"></div>

                  <div className="space-y-12">
                    {singleFlight?.itinerary?.map((item, index) => (
                      <div key={index} className="relative flex gap-10 group">
                        {/* Day Bubble */}
                        <div className="z-10 flex-shrink-0 w-12 h-12 bg-[#D34D3D] text-white flex items-center justify-center rounded-xl font-black text-lg shadow-lg shadow-red-200 group-hover:scale-110 transition-transform">
                          {item.day}
                        </div>

                        <div className="flex-1 bg-white p-6 rounded-2xl border border-gray-900 shadow-sm group-hover:shadow-md transition-shadow relative">
                          <div className="flex justify-between items-start mb-4">
                            <div>
                              <h3 className="text-xl font-bold text-gray-900">
                                {item.title[locale]}
                              </h3>
                              <p className="text-xs font-bold text-[#D34D3D] mt-1">
                                {item.time}
                              </p>
                            </div>
            ...
            />
            <Accordion
              title={'Cruise Amenities'}
              content={
                <div className="grid grid-cols-2 md:grid-cols-3">
                  <div className="">
                    <h1 className="underline">
                      {singleFlight?.amenities?.diningOptions?.title[locale]}
                    </h1>
                    <div className="">
                      {singleFlight?.amenities?.diningOptions?.items[
                        locale
                      ].map((item) => (
                  ...
                  <div className="">
                    <h1 className="underline">
                      {singleFlight?.amenities?.entertainment?.title[locale]}
                    </h1>
                    <div className="">
                      {singleFlight?.amenities?.entertainment?.items[
                        locale
                      ].map((item) => (
                        <h1 key={item} className="">
                          {item}
                  ...
                  <div className="">
                    <h1 className="underline">
                      {singleFlight?.amenities?.sportsFitness?.title[locale]}
                    </h1>
                    <div className="">
                      {singleFlight?.amenities?.sportsFitness?.items[
                        locale
                      ].map((item) => (
                        <h1 key={item} className="">
                          {item}
                  ...
                  <div className="">
                    <h1 className="underline">
                      {
                        singleFlight?.amenities?.wellnessRelaxation?.title[
                          locale
                        ]
                      }
                    </h1>
                    <div className="">
                      {singleFlight?.amenities?.wellnessRelaxation?.items[
                        locale
                      ].map((item) => (
                        <h1 key={item} className="">
                          {item}
                  ...
                  <div className="">
                    <h1 className="underline">
                      {singleFlight?.amenities?.familyKids?.title[locale]}
                    </h1>
                    <div className="">
                      {singleFlight?.amenities?.familyKids?.items[locale].map(
                        (item) => (
                          <h1 key={item} className="">
                            {item}
                          </h1>
                  ...
                  <div className="">
                    <h1 className="underline">
                      {singleFlight?.amenities?.accommodations?.title[locale]}
                    </h1>
                    <div className="">
                      {singleFlight?.amenities?.accommodations?.items[
                        locale
                      ].map((item) => (
                        <h1 key={item} className="">
                          {item}
