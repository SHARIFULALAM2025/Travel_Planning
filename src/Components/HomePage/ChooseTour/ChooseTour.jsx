        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-14 gap-6">
          ...
          <div>
            ...
            <p className="mt-3 text-gray-500 max-w-xl">
              Find your next travel adventure and explore journeys crafted
              for every traveler — from wildlife expeditions to seaside escapes.
            </p>
          </div>
...
>
  ...
  <div className="mt-2 h-[2px] w-0 bg-blue-600 
  group-hover:w-8 transition-all duration-300 rounded-full"></div>
</button>
            );
          })}
        </div>
